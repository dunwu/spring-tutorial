...
public class UserController {
    ...
    public BaseResult add(@ApiParam(name = "name", value = "姓名", required = true) @RequestParam("name") String name,
                          @ApiParam(name = "email", value = "姓名", required = true) @RequestParam("email")
                              String email) {
        // 略去数据库操作：插入一条新记录
