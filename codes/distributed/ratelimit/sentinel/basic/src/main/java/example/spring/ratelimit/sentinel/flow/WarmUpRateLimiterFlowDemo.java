package example.spring.ratelimit.sentinel.flow;
...
/**
 * When {@link com.alibaba.csp.sentinel.slots.block.flow.FlowRule#controlBehavior} set to {@link com.alibaba.csp.sentinel.slots.block.RuleConstant#CONTROL_BEHAVIOR_WARM_UP_RATE_LIMITER}, real passed
 * qps will gradually increase to {@link com.alibaba.csp.sentinel.slots.block.flow.FlowRule#count}, other than burst increasing, and after the passed qps reaches
 * the threshold, the request will pass at a constant interval.
 * <p>
 * In short, {@link com.alibaba.csp.sentinel.slots.block.RuleConstant#CONTROL_BEHAVIOR_WARM_UP_RATE_LIMITER} behaves like
 * {@link com.alibaba.csp.sentinel.slots.block.RuleConstant#CONTROL_BEHAVIOR_WARM_UP} + {@link com.alibaba.csp.sentinel.slots.block.RuleConstant#CONTROL_BEHAVIOR_RATE_LIMITER}.
 * </p>
 *
 * <p/>
