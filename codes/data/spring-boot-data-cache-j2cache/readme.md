...
```
j2cache.broadcast = io.github.dunwu.springboot.support.redis.SpringRedisPubSubPolicy
```
在j2cache.properties中配置,使用springRedis替换二级缓存
```
j2cache.L2.provider_class = io.github.dunwu.springboot.support.redis.SpringRedisProvider
