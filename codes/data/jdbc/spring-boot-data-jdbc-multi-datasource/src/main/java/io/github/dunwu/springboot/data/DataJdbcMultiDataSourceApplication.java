...
public class DataJdbcMultiDataSourceApplication implements CommandLineRunner {

    private final UserDao mysqlUserDao;

    private final UserDao h2UserDao;

    public DataJdbcMultiDataSourceApplication(@Qualifier("mysqlUserDao") UserDao mysqlUserDao,
    ...
    public static void main(String[] args) {
        SpringApplication.run(DataJdbcMultiDataSourceApplication.class, args);
    }
