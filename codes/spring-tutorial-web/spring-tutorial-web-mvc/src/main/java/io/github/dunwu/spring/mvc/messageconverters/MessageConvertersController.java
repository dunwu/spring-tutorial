...
public class MessageConvertersController {
    ...
    // Jaxb2RootElementHttpMessageConverter (requires JAXB2 on the classpath - useful for
    // serving clients that expect to work with XML)
    ...
    // AtomFeedHttpMessageConverter (requires Rome on the classpath - useful for serving
    // Atom feeds)
    ...
    // RssChannelHttpMessageConverter (requires Rome on the classpath - useful for serving
    // RSS feeds)
