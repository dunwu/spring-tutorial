...
(function (window, undefined) {
  ...
  var // Promise methods
      promiseMethods = 'done fail isResolved isRejected promise then always pipe'.split(' '), // Static reference to
                                                                                              // slice
      sliceDeferred = [].slice
  ...
  jQuery.support = (function () {
    ...
    bodyStyle = {
      visibility: 'hidden', width: 0, height: 0, border: 0, margin: 0, // Set background to avoid IE crashes when
                                                                       // removing (#9028)
      background: 'none'
    }
    for (i in bodyStyle) {
  ...
  var runtil = /Until$/, rparentsprev = /^(?:parents|prevUntil|prevAll)/, // Note: This RegExp should be improved, or
                                                                          // likely pulled from
      // Sizzle
      rmultiselector = /,/, isSimple = /^.[^:#\[\.,]*$/, slice = Array.prototype.slice, POS = jQuery.expr.match.POS, // methods
                                                                                                                     // guaranteed
                                                                                                                     // to
                                                                                                                     // produce
                                                                                                                     // a
  ...
  var rinlinejQuery = / jQuery\d+="(?:\d+|null)"/g, rleadingWhitespace = /^\s+/,
      ...
      rtbody = /<tbody/i, rhtml = /<|&#?\w+;/, rnocache = /<(?:script|object|embed|option|style)/i, // checked="checked"
                                                                                                    // or checked
