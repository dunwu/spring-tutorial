package io.github.zp1024.spring.common.dozer;

import io.github.zp1024.spring.common.dozer.vo.SameAttributeA;
import io.github.zp1024.spring.common.dozer.vo.SourceBean;
import io.github.zp1024.spring.common.dozer.vo.Status;
import io.github.zp1024.spring.common.dozer.vo.UserPrime;
import junit.framework.TestCase;
import io.github.zp1024.spring.common.dozer.vo.Dest;
import io.github.zp1024.spring.common.dozer.vo.NotSameAttributeA;
import io.github.zp1024.spring.common.dozer.vo.NotSameAttributeB;
import io.github.zp1024.spring.common.dozer.vo.SameAttributeB;
import io.github.zp1024.spring.common.dozer.vo.Source;
import io.github.zp1024.spring.common.dozer.vo.TargetBean;
import io.github.zp1024.spring.common.dozer.vo.User;
import io.github.zp1024.spring.common.dozer.vo.UserGroup;
import io.github.zp1024.spring.common.dozer.vo.UserGroupPrime;
...
import io.github.zp1024.spring.common.dozer.vo.*;
...
public class CustomMappingTest extends TestCase {
    ...
    public void testSameAttributeMapping() {
        ...
        log.debug("Source -> Destination success. id={}, name={}, date={}", desc.getId(), desc.getName(), desc.getDate());
    }
    ...
    public void testNotSameAttributeMapping() {
        ...
        Assert.assertNotNull(desc);
        log.debug("Source -> Destination success. id={}, value={}, date={}", desc.getId(), desc.getValue(), desc.getDate());
    }
    ...
    public void testAnnotationMapping() {
        ...
        Assert.assertNotNull(desc);
        log.debug("Source -> Destination success. pk={}, name={}, data={}", desc.getPk(), desc.getName(), desc.getBinaryData());
    }
